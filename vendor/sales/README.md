...
SpSales - the Ruby gem for the Selling Partner API for Sales
...
```shell
gem build sp_sales.gemspec
```

Then either install the gem locally:

```shell
gem install ./sp_sales-1.0.0.gem
```
(for development, run `gem install --dev ./sp_sales-1.0.0.gem` to install the development dependencies)
...
If the Ruby gem is hosted at a git repository: https://github.com/GIT_USER_ID/GIT_REPO_ID, then add the following in the Gemfile:
    ...
    gem 'sp_sales', :git => 'https://github.com/GIT_USER_ID/GIT_REPO_ID.git'
...
api_instance = SpSales::SalesApi.new
...
------------ | ------------- | ------------- | -------------
*SpSales::SalesApi* | [**get_order_metrics**](docs/SalesApi.md#get_order_metrics) | **GET** /sales/v1/orderMetrics | 

## Documentation for Models

 - [SpSales::Decimal](docs/Decimal.md)
 - [SpSales::Error](docs/Error.md)
 - [SpSales::ErrorList](docs/ErrorList.md)
 - [SpSales::GetOrderMetricsResponse](docs/GetOrderMetricsResponse.md)
 - [SpSales::Money](docs/Money.md)
 - [SpSales::OrderMetricsInterval](docs/OrderMetricsInterval.md)
 - [SpSales::OrderMetricsList](docs/OrderMetricsList.md)
