  ...
  module SpFeeds2020
    class FeedsApi
      ...
      def cancel_feed(feed_id, opts = {})
        data = cancel_feed_with_http_info(feed_id, opts)
        return data
      end
      ...
      # @param feed_id The identifier for the feed. This identifier is unique only in combination with a seller ID.
      # @param [Hash] opts the optional parameters
      # @return [Array<(CancelFeedResponse)>] CancelFeedResponse data, response status code and response headers
      ...
      # @param feed_id The identifier for the feed. This identifier is unique only in combination with a seller ID.
      # @param [Hash] opts the optional parameters
      # @return [Array<(GetFeedResponse)>] GetFeedResponse data, response status code and response headers
      ...
      # @param feed_document_id The identifier of the feed document.
      # @param [Hash] opts the optional parameters
      # @return [Array<(GetFeedDocumentResponse)>] GetFeedDocumentResponse data, response status code and response headers
