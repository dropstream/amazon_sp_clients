  ...
  module SpMessaging
    class MessagingApi
      ...
      def send_invoice(body, marketplace_ids, amazon_order_id, opts = {})
        data = send_invoice_with_http_info(body, marketplace_ids, amazon_order_id, opts)
        return data
      end
      ...
      # @param amazon_order_id An Amazon order identifier. This identifies the order for which a message is sent.
      # @param [Hash] opts the optional parameters
      # @return [Array<(InvoiceResponse)>] InvoiceResponse data, response status code and response headers
