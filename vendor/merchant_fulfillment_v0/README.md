...
api_instance = SpMerchantFulfillmentV0::MerchantFulfillmentApi.new
body = SpMerchantFulfillmentV0::CreateShipmentRequest.new # CreateShipmentRequest | The request schema for the `CreateShipment` operation.
...
api_instance = SpMerchantFulfillmentV0::MerchantFulfillmentApi.new
body = SpMerchantFulfillmentV0::GetAdditionalSellerInputsRequest.new # GetAdditionalSellerInputsRequest | The request schema for the `GetAdditionalSellerInputs` operation.
...
api_instance = SpMerchantFulfillmentV0::MerchantFulfillmentApi.new
body = SpMerchantFulfillmentV0::GetEligibleShipmentServicesRequest.new # GetEligibleShipmentServicesRequest | The request schema for the `GetEligibleShipmentServices` operation.
...
## Documentation for Models
 ...
 - [SpMerchantFulfillmentV0::Benefits](docs/Benefits.md)
 ...
 - [SpMerchantFulfillmentV0::DangerousGoodsDetails](docs/DangerousGoodsDetails.md)
 ...
 - [SpMerchantFulfillmentV0::ExcludedBenefit](docs/ExcludedBenefit.md)
 - [SpMerchantFulfillmentV0::ExcludedBenefitReasonCodes](docs/ExcludedBenefitReasonCodes.md)
 - [SpMerchantFulfillmentV0::ExcludedBenefits](docs/ExcludedBenefits.md)
 ...
 - [SpMerchantFulfillmentV0::IncludedBenefits](docs/IncludedBenefits.md)
 ...
 - [SpMerchantFulfillmentV0::LiquidVolume](docs/LiquidVolume.md)
