...
SpReports2021 - the Ruby gem for the Selling Partner API for Reports
...
```shell
gem build sp_reports_2021.gemspec
```

Then either install the gem locally:

```shell
gem install ./sp_reports_2021-1.0.0.gem
```
(for development, run `gem install --dev ./sp_reports_2021-1.0.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'sp_reports_2021', '~> 1.0.0'

### Install from Git

If the Ruby gem is hosted at a git repository: https://github.com/GIT_USER_ID/GIT_REPO_ID, then add the following in the Gemfile:

    gem 'sp_reports_2021', :git => 'https://github.com/GIT_USER_ID/GIT_REPO_ID.git'
...
rescue SpReports2021::ApiError => e
...
------------ | ------------- | ------------- | -------------
*SpReports2021::ReportsApi* | [**cancel_report**](docs/ReportsApi.md#cancel_report) | **DELETE** /reports/2021-06-30/reports/{reportId} | 
*SpReports2021::ReportsApi* | [**cancel_report_schedule**](docs/ReportsApi.md#cancel_report_schedule) | **DELETE** /reports/2021-06-30/schedules/{reportScheduleId} | 
*SpReports2021::ReportsApi* | [**create_report**](docs/ReportsApi.md#create_report) | **POST** /reports/2021-06-30/reports | 
*SpReports2021::ReportsApi* | [**create_report_schedule**](docs/ReportsApi.md#create_report_schedule) | **POST** /reports/2021-06-30/schedules | 
*SpReports2021::ReportsApi* | [**get_report**](docs/ReportsApi.md#get_report) | **GET** /reports/2021-06-30/reports/{reportId} | 
*SpReports2021::ReportsApi* | [**get_report_document**](docs/ReportsApi.md#get_report_document) | **GET** /reports/2021-06-30/documents/{reportDocumentId} | 
*SpReports2021::ReportsApi* | [**get_report_schedule**](docs/ReportsApi.md#get_report_schedule) | **GET** /reports/2021-06-30/schedules/{reportScheduleId} | 
*SpReports2021::ReportsApi* | [**get_report_schedules**](docs/ReportsApi.md#get_report_schedules) | **GET** /reports/2021-06-30/schedules | 
*SpReports2021::ReportsApi* | [**get_reports**](docs/ReportsApi.md#get_reports) | **GET** /reports/2021-06-30/reports | 

## Documentation for Models

 - [SpReports2021::CreateReportResponse](docs/CreateReportResponse.md)
 - [SpReports2021::CreateReportScheduleResponse](docs/CreateReportScheduleResponse.md)
 - [SpReports2021::CreateReportScheduleSpecification](docs/CreateReportScheduleSpecification.md)
 - [SpReports2021::CreateReportSpecification](docs/CreateReportSpecification.md)
 - [SpReports2021::Error](docs/Error.md)
 - [SpReports2021::ErrorList](docs/ErrorList.md)
 - [SpReports2021::GetReportsResponse](docs/GetReportsResponse.md)
 - [SpReports2021::Report](docs/Report.md)
 - [SpReports2021::ReportDocument](docs/ReportDocument.md)
 - [SpReports2021::ReportList](docs/ReportList.md)
 - [SpReports2021::ReportOptions](docs/ReportOptions.md)
 - [SpReports2021::ReportSchedule](docs/ReportSchedule.md)
 - [SpReports2021::ReportScheduleList](docs/ReportScheduleList.md)
