  ...
  module SpProductFeesV0
    class FeesApi
      ...
      def get_my_fees_estimates(body, opts = {})
        data = get_my_fees_estimates_with_http_info(body, opts)
        return data
      end
      ...
      # @param body 
      # @param [Hash] opts the optional parameters
      # @return [Array<(GetMyFeesEstimatesResponse)>] GetMyFeesEstimatesResponse data, response status code and response headers
