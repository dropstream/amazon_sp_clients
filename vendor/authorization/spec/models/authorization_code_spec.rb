...
# Unit tests for SpAuthorization::AuthorizationCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthorizationCode' do
  before do
    # run before each test
    @instance = SpAuthorization::AuthorizationCode.new
  end
  ...
  describe 'test an instance of AuthorizationCode' do
    it 'should create an instance of AuthorizationCode' do
      expect(@instance).to be_instance_of(SpAuthorization::AuthorizationCode)
    end
  end
