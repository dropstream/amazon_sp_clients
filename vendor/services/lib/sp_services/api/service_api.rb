  ...
  module SpServices
    class ServiceApi
      ...
      def assign_appointment_resources(body, service_job_id, appointment_id, opts = {})
        data = assign_appointment_resources_with_http_info(body, service_job_id, appointment_id, opts)
        return data
      end
      ...
      # @param appointment_id An Amazon-defined identifier of active service job appointment.
      # @param [Hash] opts the optional parameters
      # @return [Array<(AssignAppointmentResourcesResponse)>] AssignAppointmentResourcesResponse data, response status code and response headers
      ...
      def cancel_reservation(reservation_id, marketplace_ids, opts = {})
        data = cancel_reservation_with_http_info(reservation_id, marketplace_ids, opts)
        return data
      end
      ...
      # @param marketplace_ids An identifier for the marketplace in which the resource operates.
      # @param [Hash] opts the optional parameters
      # @return [Array<(CancelReservationResponse)>] CancelReservationResponse data, response status code and response headers
      ...
      def create_reservation(body, marketplace_ids, opts = {})
        data = create_reservation_with_http_info(body, marketplace_ids, opts)
        return data
      end
      ...
      # @param marketplace_ids An identifier for the marketplace in which the resource operates.
      # @param [Hash] opts the optional parameters
      # @return [Array<(CreateReservationResponse)>] CreateReservationResponse data, response status code and response headers
      ...
      def create_service_document_upload_destination(body, opts = {})
        data = create_service_document_upload_destination_with_http_info(body, opts)
        return data
      end
      ...
      # @param body Upload document operation input details.
      # @param [Hash] opts the optional parameters
      # @return [Array<(CreateServiceDocumentUploadDestination)>] CreateServiceDocumentUploadDestination data, response status code and response headers
      ...
      def get_appointment_slots(asin, store_id, marketplace_ids, opts = {})
        data = get_appointment_slots_with_http_info(asin, store_id, marketplace_ids, opts)
        return data
      end
      ...
      # @option opts [String] :start_time A time from which the appointment slots will be retrieved. The specified time must be in ISO 8601 format. If &#x60;startTime&#x60; is provided, &#x60;endTime&#x60; should also be provided. Default value is as per business configuration.
      # @option opts [String] :end_time A time up to which the appointment slots will be retrieved. The specified time must be in ISO 8601 format. If &#x60;endTime&#x60; is provided, &#x60;startTime&#x60; should also be provided. Default value is as per business configuration. Maximum range of appointment slots can be 90 days.
      # @return [Array<(GetAppointmentSlotsResponse)>] GetAppointmentSlotsResponse data, response status code and response headers
      ...
      def get_appointmment_slots_by_job_id(service_job_id, marketplace_ids, opts = {})
        data = get_appointmment_slots_by_job_id_with_http_info(service_job_id, marketplace_ids, opts)
        return data
      end
      ...
      def get_fixed_slot_capacity(body, marketplace_ids, resource_id, opts = {})
        data = get_fixed_slot_capacity_with_http_info(body, marketplace_ids, resource_id, opts)
        return data
      end
      ...
      # @param [Hash] opts the optional parameters
      # @option opts [String] :next_page_token Next page token returned in the response of your previous request.
      # @return [Array<(FixedSlotCapacity)>] FixedSlotCapacity data, response status code and response headers
      ...
      def get_range_slot_capacity(body, marketplace_ids, resource_id, opts = {})
        data = get_range_slot_capacity_with_http_info(body, marketplace_ids, resource_id, opts)
        return data
      end
      ...
      # @param [Hash] opts the optional parameters
      # @option opts [String] :next_page_token Next page token returned in the response of your previous request.
      # @return [Array<(RangeSlotCapacity)>] RangeSlotCapacity data, response status code and response headers
      ...
      def set_appointment_fulfillment_data(body, service_job_id, appointment_id, opts = {})
        data = set_appointment_fulfillment_data_with_http_info(body, service_job_id, appointment_id, opts)
        return data
      end
      ...
      # @param appointment_id An Amazon-defined identifier of active service job appointment.
      # @param [Hash] opts the optional parameters
      # @return [Array<(String)>] String data, response status code and response headers
      ...
      def update_reservation(body, marketplace_ids, reservation_id, opts = {})
        data = update_reservation_with_http_info(body, marketplace_ids, reservation_id, opts)
        return data
      end
      ...
      # @param reservation_id Reservation Identifier
      # @param [Hash] opts the optional parameters
      # @return [Array<(UpdateReservationResponse)>] UpdateReservationResponse data, response status code and response headers
      ...
      def update_schedule(body, marketplace_ids, resource_id, opts = {})
        data = update_schedule_with_http_info(body, marketplace_ids, resource_id, opts)
        return data
      end
      ...
      # @param resource_id Resource (store) Identifier
      # @param [Hash] opts the optional parameters
      # @return [Array<(UpdateScheduleResponse)>] UpdateScheduleResponse data, response status code and response headers
