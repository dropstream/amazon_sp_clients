...
# Unit tests for AmznSpOrdersV0::OrderItemsBuyerInfoList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderItemsBuyerInfoList' do
  before do
    # run before each test
    @instance = AmznSpOrdersV0::OrderItemsBuyerInfoList.new
  end
  ...
  describe 'test an instance of OrderItemsBuyerInfoList' do
    it 'should create an instance of OrderItemsBuyerInfoList' do
      expect(@instance).to be_instance_of(AmznSpOrdersV0::OrderItemsBuyerInfoList)
    end
  end
