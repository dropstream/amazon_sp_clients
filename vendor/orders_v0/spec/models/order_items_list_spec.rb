...
# Unit tests for AmazonSpClients::SpOrdersV0::OrderItemsList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderItemsList' do
  before do
    # run before each test
    @instance = AmazonSpClients::SpOrdersV0::OrderItemsList.new
  end
  ...
  describe 'test an instance of OrderItemsList' do
    it 'should create an instance of OrderItemsList' do
      expect(@instance).to be_instance_of(AmazonSpClients::SpOrdersV0::OrderItemsList)
    end
  end
