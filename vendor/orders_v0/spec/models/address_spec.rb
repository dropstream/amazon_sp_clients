...
# Unit tests for AmazonSpClients::SpOrdersV0::Address
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Address' do
  before do
    # run before each test
    @instance = AmazonSpClients::SpOrdersV0::Address.new
  end
  ...
  describe 'test an instance of Address' do
    it 'should create an instance of Address' do
      expect(@instance).to be_instance_of(AmazonSpClients::SpOrdersV0::Address)
    end
  end
