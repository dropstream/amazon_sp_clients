  ...
  module SpProductPricingV0
    class ProductPricingApi
      ...
      def get_item_offers_batch(body, opts = {})
        data = get_item_offers_batch_with_http_info(body, opts)
        return data
      end
      ...
      # @param body The request associated with the &#x60;getItemOffersBatch&#x60; API call.
      # @param [Hash] opts the optional parameters
      # @return [Array<(GetItemOffersBatchResponse)>] GetItemOffersBatchResponse data, response status code and response headers
      ...
      def get_listing_offers_batch(body, opts = {})
        data = get_listing_offers_batch_with_http_info(body, opts)
        return data
      end
      ...
      # @param body The request associated with the &#x60;getListingOffersBatch&#x60; API call.
      # @param [Hash] opts the optional parameters
      # @return [Array<(GetListingOffersBatchResponse)>] GetListingOffersBatchResponse data, response status code and response headers
