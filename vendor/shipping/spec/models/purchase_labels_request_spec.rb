...
# Unit tests for AmazonSpClients::SpShipping::PurchaseLabelsRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseLabelsRequest' do
  before do
    # run before each test
    @instance = AmazonSpClients::SpShipping::PurchaseLabelsRequest.new
  end
  ...
  describe 'test an instance of PurchaseLabelsRequest' do
    it 'should create an instance of PurchaseLabelsRequest' do
      expect(@instance).to be_instance_of(AmazonSpClients::SpShipping::PurchaseLabelsRequest)
    end
  end
