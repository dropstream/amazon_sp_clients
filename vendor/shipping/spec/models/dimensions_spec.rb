...
# Unit tests for AmazonSpClients::SpShipping::Dimensions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Dimensions' do
  before do
    # run before each test
    @instance = AmazonSpClients::SpShipping::Dimensions.new
  end
  ...
  describe 'test an instance of Dimensions' do
    it 'should create an instance of Dimensions' do
      expect(@instance).to be_instance_of(AmazonSpClients::SpShipping::Dimensions)
    end
  end
