...
# Unit tests for SpShipping::CreateShipmentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateShipmentRequest' do
  before do
    # run before each test
    @instance = SpShipping::CreateShipmentRequest.new
  end
  ...
  describe 'test an instance of CreateShipmentRequest' do
    it 'should create an instance of CreateShipmentRequest' do
      expect(@instance).to be_instance_of(SpShipping::CreateShipmentRequest)
    end
  end
