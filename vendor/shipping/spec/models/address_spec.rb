...
# Unit tests for AmazonSpClients::SpShipping::Address
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Address' do
  before do
    # run before each test
    @instance = AmazonSpClients::SpShipping::Address.new
  end
  ...
  describe 'test an instance of Address' do
    it 'should create an instance of Address' do
      expect(@instance).to be_instance_of(AmazonSpClients::SpShipping::Address)
    end
  end
