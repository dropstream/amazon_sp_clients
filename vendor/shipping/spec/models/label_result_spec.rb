...
# Unit tests for AmazonSpClients::SpShipping::LabelResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelResult' do
  before do
    # run before each test
    @instance = AmazonSpClients::SpShipping::LabelResult.new
  end
  ...
  describe 'test an instance of LabelResult' do
    it 'should create an instance of LabelResult' do
      expect(@instance).to be_instance_of(AmazonSpClients::SpShipping::LabelResult)
    end
  end
