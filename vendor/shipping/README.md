...
api_instance = SpShipping::ShippingApi.new
body = SpShipping::CreateShipmentRequest.new # CreateShipmentRequest | CreateShipmentRequest Body
...
api_instance = SpShipping::ShippingApi.new
body = SpShipping::GetRatesRequest.new # GetRatesRequest | GetRatesRequest body
...
api_instance = SpShipping::ShippingApi.new
body = SpShipping::PurchaseLabelsRequest.new # PurchaseLabelsRequest | PurchaseShippingLabelRequest body
...
api_instance = SpShipping::ShippingApi.new
body = SpShipping::PurchaseShipmentRequest.new # PurchaseShipmentRequest | PurchaseShipmentRequest body
...
api_instance = SpShipping::ShippingApi.new
body = SpShipping::RetrieveShippingLabelRequest.new # RetrieveShippingLabelRequest | RetrieveShippingLabelRequest body
